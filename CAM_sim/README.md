...
ctest --test-dir CAM_sim/cmake-build-release
```

## Export A Real Trace

Run from the repository root so `python -m CAM_sim.tools.export_graphhop_trace`
...
python -m CAM_sim.tools.export_graphhop_trace \
  ...
  --radius 2 \
  --output CAM_sim/traces/pubmed_8h16b_r2.trace
```
...
./cmake-build-release/analog_cam_cpp/analog_cam_reuse \
  --trace traces/pubmed_8h16b_r2.trace \
