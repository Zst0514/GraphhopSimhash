...
void write_report_json(
    ...
    out << "  \"replacement_policy\": \"" << json_escape(stats.replacement_policy) << "\",\n";
    ...
    out << "  \"total_cam_bytes\": " << stats.total_cam_bytes << ",\n";
    out << "  \"node_entry_bytes\": " << stats.node_entry_bytes << ",\n";
    out << "  \"capacity_limit_nodes\": " << stats.capacity_limit_nodes << ",\n";
    ...
    out << "  \"cam_evictions\": " << stats.cam_evictions << ",\n";
    out << "  \"max_active_nodes\": " << stats.max_active_nodes << ",\n";
    out << "  \"max_active_rows\": " << stats.max_active_rows << ",\n";
