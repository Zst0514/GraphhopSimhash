...
| Setting | Cost | Rand Drop | Degree Drop | TSER Drop | Context Drop | Best |
|---|---:|---:|---:|---:|---:|---|
| All BFPA4 | 0.287 | - | - | - | - | 0.99% baseline |
| 10% BFPA6 + 90% BFPA4 | 0.298 | 0.89% | 0.82% | 0.76% | 0.78% | TSER |
| 20% BFPA6 + 80% BFPA4 | 0.309 | 0.74% | 0.68% | 0.54% | 0.65% | TSER |
| 30% BFPA6 + 70% BFPA4 | 0.319 | 0.64% | 0.55% | 0.49% | 0.48% | Context / TSER |
| 10% BFPA8 + 90% BFPA4 | 0.309 | 0.91% | 0.77% | 0.76% | 0.84% | TSER |
| 20% BFPA8 + 80% BFPA4 | 0.330 | 0.69% | 0.53% | 0.47% | 0.58% | TSER |
| 30% BFPA8 + 70% BFPA4 | 0.351 | 0.72% | 0.58% | 0.44% | 0.53% | TSER |
| 10% BFPA8 + 20% BFPA6 + 70% BFPA4 | 0.330 | 0.72% | 0.63% | 0.46% | 0.51% | TSER |
| 20% BFPA8 + 20% BFPA6 + 60% BFPA4 | 0.351 | 0.68% | 0.74% | 0.36% | 0.41% | TSER |
...
TSER / Context 在 Cora 上比 Degree 更强，说明语义边界和上下文风险对 BFP refinement 有额外价值。
```
...
| 平衡 | 30% BFPA6 + 70% BFPA4 | Context / TSER | 0.319 | 0.48%-0.49% |
...
| 5% BFPA6 + 95% BFPA4 | 0.293 | 1.12% | 0.93% | 0.96% | 1.09% | Degree |
| 10% BFPA6 + 90% BFPA4 | 0.298 | 1.08% | 0.79% | 0.83% | 0.96% | Degree |
| 15% BFPA6 + 85% BFPA4 | 0.303 | 1.01% | 0.70% | 0.75% | 0.89% | Degree |
| 20% BFPA6 + 80% BFPA4 | 0.309 | 0.95% | 0.61% | 0.68% | 0.74% | Degree |
| 25% BFPA6 + 75% BFPA4 | 0.314 | 0.89% | 0.58% | 0.62% | 0.69% | Degree |
| 30% BFPA6 + 70% BFPA4 | 0.319 | 0.81% | 0.54% | 0.58% | 0.60% | Degree |
| 40% BFPA6 + 60% BFPA4 | 0.330 | 0.69% | 0.44% | 0.46% | 0.48% | Degree |

PubMed 单档 BFPA8 refinement：

| Setting | Cost | Rand Drop | Degree Drop | TSER Drop | Context Drop | Best |
|---|---:|---:|---:|---:|---:|---|
| 5% BFPA8 + 95% BFPA4 | 0.298 | 1.11% | 0.92% | 0.96% | 1.08% | Degree |
| 10% BFPA8 + 90% BFPA4 | 0.309 | 1.06% | 0.77% | 0.81% | 0.94% | Degree |
| 15% BFPA8 + 85% BFPA4 | 0.319 | 1.00% | 0.69% | 0.74% | 0.86% | Degree |
| 20% BFPA8 + 80% BFPA4 | 0.330 | 0.95% | 0.62% | 0.67% | 0.72% | Degree |
| 25% BFPA8 + 75% BFPA4 | 0.341 | 0.89% | 0.58% | 0.59% | 0.65% | Degree |
| 30% BFPA8 + 70% BFPA4 | 0.351 | 0.81% | 0.53% | 0.56% | 0.57% | Degree |
| 40% BFPA8 + 60% BFPA4 | 0.373 | 0.68% | 0.42% | 0.44% | 0.43% | Degree |

PubMed hybrid refinement：

| Setting | Cost | Rand Drop | Degree Drop | TSER Drop | Context Drop | Best |
|---|---:|---:|---:|---:|---:|---|
| 5% BFPA8 + 10% BFPA6 + 85% BFPA4 | 0.309 | 1.01% | 0.70% | 0.75% | 0.88% | Degree |
| 10% BFPA8 + 10% BFPA6 + 80% BFPA4 | 0.319 | 0.95% | 0.60% | 0.67% | 0.73% | Degree |
| 15% BFPA8 + 15% BFPA6 + 70% BFPA4 | 0.335 | 0.81% | 0.53% | 0.56% | 0.58% | Degree |
| 10% BFPA8 + 30% BFPA6 + 60% BFPA4 | 0.341 | 0.69% | 0.42% | 0.44% | 0.47% | Degree |
| 20% BFPA8 + 20% BFPA6 + 60% BFPA4 | 0.351 | 0.70% | 0.43% | 0.43% | 0.46% | Degree / TSER |
...
4. Cora 更需要 TSER / Context，因为语义边界和上下文风险更明显。
...
|---|---|---|---:|---:|
| Cora | 30% BFPA6 + 70% BFPA4 | Context / TSER | 0.319 | 0.48%-0.49% |
