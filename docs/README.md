...
已删除/合并早期探索文档：partial-depth / token budget / FFN channel gating，以及 Graph-Bit 的 demand-fetch、bound、bucket、dataflow 分散文档。主线内容已合并到 [GRAPH_BIT_NPU_DESIGN.md](npu/GRAPH_BIT_NPU_DESIGN.md)、[GRAPH_BIT_EARLY_STOP_IMPLEMENTATION.md](npu/GRAPH_BIT_EARLY_STOP_IMPLEMENTATION.md) 和 [GRAPH_BIT_TRACE_DRIVEN_SCHEDULER.md](npu/GRAPH_BIT_TRACE_DRIVEN_SCHEDULER.md)。
