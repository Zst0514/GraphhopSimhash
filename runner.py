...
def build_real_quant_policy_configs(args):
    if args.real_quant_policy_suite == "w4a8_budget":
        ...
        configs = [
            ...
            (f"QuantTSERTopK_{int8_tag}", "quant_tser_int8_budget"),
            (f"DegreeErrorTopK_{int8_tag}", "degree_error_int8_budget"),
            (f"TSERErrorTopK_{int8_tag}", "tser_error_int8_budget"),
        ]
    ...
    configs = [
        ...
        ("TSERTopK", "tser_topk"),
        ("QuantTSERTopK", "quant_tser_topk"),
        ("DegreeErrorTopK", "degree_error_topk"),
        ("TSERErrorTopK", "tser_error_topk"),
